...
import { Board1, Gradient } from '../../assets'
    ...
    return (
        <View style={styles.mainBackground}>
            ...
            <View style={styles.DesprictionBox}>
                <Heading text={"Welcome to Matrimonial App"} fontFamily="RobotoCondensed-ExtraBold" fontSize={5} textAlign="center" color={multiThemeColor().WHITE} />
